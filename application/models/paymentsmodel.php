...
public function count_all_payments_search($requestData)
    {
	...
	public function get_all_payments_search($requestData)
    {
			...
			1=> 'customer.cut_id_no',
			2=> 'name',
			3 =>'wedding_hall.w_code', 
			4 => 'booking_date',
			5=> 'final_price',
			6=> 'payment_amount',
			7=> 'payment_date',
...
public function count_all_emp_payments_search($requestData)
    {
