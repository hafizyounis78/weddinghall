...
<div class="content">
	...
	<form class="forget-form" action="index.html" method="post">
		...
		<p>
			 الرجاء ادخل بريدك الالكتروني حتى يتم اعادة تعين كلمة المرور
		</p>
		<div class="form-group">
			<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="البريد الالكتروني" name="email"/>
		</div>
		<div class="form-actions">
			<button type="button" id="back-btn" class="btn btn-default">رجوع</button>
			<button type="submit" class="btn btn-success uppercase pull-right">متابعة</button>
		</div>
	</form>
